    ...
    Column {
        ...
        Flickable {
            ...
            Column {
                ...
                property var depInstallerPlugin: {
                    for (var i = 0; i < plugins.plugins.length; i++) {
                        if (plugins.plugins[i].id === "dependency-installer")
                ...
                CCard {
                    width: parent.width
                    visible: pluginsPage.depInstallerPlugin !== null
                    Row {
                        width: parent.width
                        Text {
                        ...
                        CButton {
                            ...
                            onClicked: {
                                ...
                                if (!gameName) { toastLabel.text = "Select a game first"; toastPopup.open(); return; }
                                var g = games.getGame(gameName);
                                if (!g || !g.mainPath) { toastLabel.text = "No game directory found"; toastPopup.open(); return; }
                                // Find plugin path
                                var plugPath = pluginsPage.depInstallerPlugin.path || "";
                    ...
                    Repeater {
                        id: depList
                        model: pluginsPage.depScanResults
                        delegate: Row {
                    ...
                    CButton {
                        ...
                        onClicked: {
                            ...
                            if (gameName) {
                                var g = games.getGame(gameName);
                                if (g) { prefix = g.prefixPath || ""; prog = g.proton || ""; }
                            }
