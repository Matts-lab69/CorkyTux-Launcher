# Build CorkyTux v3.0.11 from source
...
# generates: corkytux-3.0.11-linux-x86_64.tar.gz
...
```bash
tar -xzf corkytux-3.0.11-linux-x86_64.tar.gz
cd corkytux-3.0.11 && ./install.sh
```
